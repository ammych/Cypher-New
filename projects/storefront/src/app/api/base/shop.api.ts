...
export abstract class ShopApi {
	...
	abstract getStealDealsProducts(categorySlug: string, limit: number): Observable<Product[]>;
	
	abstract getCatProducts(categorySlug: string, limit: number): Observable<Product[]>;
